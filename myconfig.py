...
STEERING_LEFT_PWM = 401         #pwm value for full left steering
STEERING_RIGHT_PWM = 321        #pwm value for full right steering
# 
...
THROTTLE_STOPPED_PWM = 338      #pwm value for no movement
